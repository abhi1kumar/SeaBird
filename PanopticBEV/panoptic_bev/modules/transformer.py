...
class VerticalTransformer(nn.Module):
    def __init__(self, in_ch, v_2d_ch, v_3d_ch, img_size_in, img_size_out, extents, img_scale, resolution, norm_act=nn.BatchNorm2d):
...
class ErrorCorrectionModule(nn.Module):
    def __init__(self, in_ch, f_2d_ch, img_size_in, img_size_out, img_scale, norm_act=nn.BatchNorm2d):
...
class FlatTransformer(nn.Module):
    def __init__(self, in_ch, f_2d_ch, extrinsics=None, bev_params=None, in_img_size=None, out_img_size=None,
                 img_scale=None, extents=None, resolution=None, norm_act=nn.BatchNorm2d):
...
class MergeFeaturesVF(nn.Module):
    def __init__(self, in_ch, norm_act=nn.BatchNorm2d):
...
class TransformerVF(nn.Module):
    def __init__(self, in_ch, tfm_ch, out_ch,  extrinsics=None, bev_params=None, H_in=None, W_in=None, Z_out=None,
                 W_out=None, img_scale=None, norm_act=nn.BatchNorm2d):
