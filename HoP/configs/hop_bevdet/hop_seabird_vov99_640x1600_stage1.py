...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_cls=dict(type='GaussianFocalLoss', reduction='mean', loss_weight=0.0),
        loss_bbox=dict(type='L1Loss', reduction='mean', loss_weight=0.0),
        norm_bbox=True),
    aux_bbox_head=[dict(
        type='CenterHead',
        in_channels=256,
        ...
        loss_cls=dict(type='GaussianFocalLoss', reduction='mean', loss_weight=1.0*0.0),
        loss_bbox=dict(type='L1Loss', reduction='mean', loss_weight=0.25*0.0),
        norm_bbox=True),],
    aux_train_cfg=[dict(
