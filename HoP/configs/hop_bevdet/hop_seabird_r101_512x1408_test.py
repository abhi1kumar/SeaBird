...
load_from = 'work_dirs/hop_seabird_r101_512x1408/epoch_24_ema.pth'
...
test_pipeline = [
    dict(type='PrepareImageInputs', data_config=data_config, sequential=True, add_adj_bbox=False, file_client_args=file_client_args),
    dict(
        type='LoadAnnotationsBEVDepth',
        bda_aug_conf=bda_aug_conf,
        classes=class_names,
...
data = dict(
    ...
    train=dict(
        data_root=data_root,
        ann_file=[data_root + 'bevdetv2-nuscenes_infos_train.pkl',data_root + 'bevdetv2-nuscenes_infos_val.pkl'],
